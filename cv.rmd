...
if(params$pdf_mode){
  cat("View this CV online with links at _trevornishida.github.io/cv_")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/trevornishida/cv/blob/main/NishidaTrevor_CV.pdf)")
}
```
...
<!-- These breaks just force a new page so skills section doesn't get cut off -->
<br>
<br>
<br>
